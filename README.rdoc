...
Build IronRuby .dll and add an irpack equivalent to cl commands of
  cl /LD foo.c bar.c baz.c /FeMyImage.dll```
  or
  cl /LD foo.c bar.c baz.c /link /out:MyImage.dll
  Prospectively: irpack -b <dir> -o --link <output>
After adding, write tests to confirm functionality!
